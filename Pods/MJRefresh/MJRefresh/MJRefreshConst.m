...
NSString *const MJRefreshHeaderIdleText = @"载入上一篇";
NSString *const MJRefreshHeaderPullingText = @"载入上一篇";
...
NSString *const MJRefreshBackFooterIdleText = @"载入下一篇";
NSString *const MJRefreshBackFooterPullingText = @"载入下一篇";
